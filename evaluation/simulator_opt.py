...
class DMtemplateOpt:
  ...
  def __init__(self, circ: QCPcircuit, noise: dict={"bitflip": 0, "phaseflip": 0, "bitphaseflip": 0, "depolarization": 0, "amplitudedamping": 0}) -> None:
    self.circ = circ
  ...
  def storeResult(self, time):
    ...
    with open(f'evaluation/outputs/{name}_opt.txt', 'w') as f:
